...
## ⇁  Shortlisted.nvim
This is a deprecated and all future changes will be to the branch `main`.

[Main](https://github.com/robot-analyticds/shortlisted.nvim/tree/main)

**STATUS**: Merging into mainline April 20th or June 9th (nice)

-------------------------------
# Legacy Shortlist.nvim README
...
Plug 'robot-analytics/shortlisted.nvim'
```
